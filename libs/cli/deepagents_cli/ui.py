...
def show_help() -> None:
    """Show top-level help information for the docagents CLI."""
    install_type = " (local)" if _is_editable_install() else ""
    banner_color = "#3b6dac"
    console.print()
    console.print(
        f"[bold {banner_color}]docagents[/bold {banner_color}]"
    ...
    console.print(
        "  docagents [OPTIONS]                           Start interactive thread"
    )
    console.print(
        "  docagents list                                List all available agents"
    )
    console.print(
        "  docagents reset --agent AGENT [--target SRC]  Reset an agent's prompt"
    )
    console.print("  docagents skills <list|create|info|delete>    Manage agent skills")
    console.print(
        "  docagents threads <list|delete>               Manage conversation threads"
    )
    console.print()
    ...
    console.print(
        "  docagents -n 'Summarize README.md'     # Run task (no local shell access)",
        style=COLORS["dim"],
    )
    console.print(
        "  docagents -n 'List files' --shell-allow-list recommended  # Use safe commands",  # noqa: E501
        style=COLORS["dim"],
    )
    console.print(
        "  docagents -n 'Search logs' --shell-allow-list ls,cat,grep # Specify list",
        style=COLORS["dim"],
    )
    console.print(
        "  docagents -n 'Fix tests' --shell-allow-list all           # Any command",
        style=COLORS["dim"],
    )
    console.print()
...
def show_reset_help() -> None:
    ...
    console.print()
    console.print("[bold]Usage:[/bold]", style=COLORS["primary"])
    console.print("  docagents reset --agent NAME [--target SRC]")
    console.print()
    console.print(
    ...
    console.print("  docagents reset --agent coder")
    console.print("  docagents reset --agent coder --target researcher")
    console.print()
...
def show_skills_help() -> None:
    ...
    console.print()
    console.print("[bold]Usage:[/bold]", style=COLORS["primary"])
    console.print("  docagents skills <command> [options]")
    console.print()
    ...
    console.print()
    console.print("[bold]Examples:[/bold]", style=COLORS["primary"])
    console.print("  docagents skills list")
    console.print("  docagents skills list --project")
    console.print("  docagents skills create my-skill")
    console.print("  docagents skills create my-skill --agent myagent")
    console.print("  docagents skills info my-skill")
    console.print("  docagents skills delete my-skill")
    console.print("  docagents skills delete my-skill --force --project")
    console.print("  docagents skills delete -h")
    console.print()
    console.print(
    ...
    console.print(
        ...
        "  2. .docagents/skills/              project skills (alias)\n"
        "  3. ~/.agents/skills/               user skills\n"
        "  4. ~/.docagents/<agent>/skills/    user skills (alias)\n"
...
def show_skills_list_help() -> None:
    ...
    console.print()
    console.print("[bold]Usage:[/bold]", style=COLORS["primary"])
    console.print("  docagents skills list [options]")
    console.print()
    console.print("[bold]Options:[/bold]", style=COLORS["primary"])
...
def show_skills_create_help() -> None:
    ...
    console.print()
    console.print("[bold]Usage:[/bold]", style=COLORS["primary"])
    console.print("  docagents skills create <name> [options]")
    console.print()
    console.print("[bold]Options:[/bold]", style=COLORS["primary"])
    console.print("  --agent NAME      Agent identifier (default: agent)")
    console.print(
    ...
    console.print()
    console.print("[bold]Examples:[/bold]", style=COLORS["primary"])
    console.print("  docagents skills create web-research")
    console.print("  docagents skills create my-skill --project")
    console.print()
...
def show_skills_info_help() -> None:
    ...
    console.print()
    console.print("[bold]Usage:[/bold]", style=COLORS["primary"])
    console.print("  docagents skills info <name> [options]")
    console.print()
    console.print("[bold]Options:[/bold]", style=COLORS["primary"])
    console.print("  --agent NAME      Agent identifier (default: agent)")
...
def show_skills_delete_help() -> None:
    ...
    console.print()
    console.print("[bold]Usage:[/bold]", style=COLORS["primary"])
    console.print("  docagents skills delete <name> [options]")
    console.print()
    console.print("[bold]Options:[/bold]", style=COLORS["primary"])
    console.print("  --agent NAME      Agent identifier (default: agent)")
    console.print("  --project         Search only in project skills")
    ...
    console.print()
    console.print("[bold]Examples:[/bold]", style=COLORS["primary"])
    console.print("  docagents skills delete old-skill")
    console.print("  docagents skills delete old-skill --force")
    console.print("  docagents skills delete old-skill --project")
    console.print()
...
def show_threads_help() -> None:
    ...
    console.print()
    console.print("[bold]Usage:[/bold]", style=COLORS["primary"])
    console.print("  docagents threads <command> [options]")
    console.print()
    console.print("[bold]Commands:[/bold]", style=COLORS["primary"])
    ...
    console.print()
    console.print("[bold]Examples:[/bold]", style=COLORS["primary"])
    console.print("  docagents threads list")
    console.print("  docagents threads list -n 10")
    console.print("  docagents threads list --agent mybot")
    console.print("  docagents threads delete abc123")
    console.print()
...
def show_threads_list_help() -> None:
    ...
    console.print()
    console.print("[bold]Usage:[/bold]", style=COLORS["primary"])
    console.print("  docagents threads list [options]")
    console.print()
    console.print("[bold]Options:[/bold]", style=COLORS["primary"])
    ...
    console.print("  docagents threads list -n 10")
    console.print("  docagents threads list --agent mybot")
    console.print("  docagents threads list --branch main -v")
    console.print("  docagents threads list --sort created --limit 50")
